...
ban = []
cr = '*590bot*'
vz = '*Terima Kasih Sudah Daftar Di 590bot*'
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: 'sabar ngab jan bnyk bacot',
				asik: 'sabar ngab jan bnyk bacot yah',
				success: 'tuh ngab udh jadi',
				levelon: '𝖫𝖾𝗏𝖾𝗅𝗂𝗇𝗀 udh aktif ngab',
				leveloff: 'off dulu levelnya tod',
				levelnoton: '𝗒𝖺𝗁 𝖲𝖺𝗒𝖺𝗇𝗀 𝖲𝖾𝗄𝖺𝗅𝗂 𝖫𝖾𝗏𝖾𝗅𝗂𝗇𝗀 𝖡𝖾𝗅𝗎𝗆 𝖽𝗂 𝖺𝗄𝗍𝗂𝖿𝗄𝖺𝗇 𝖠𝗒𝗈 𝖪𝖺𝗄 𝖫𝖺𝗉𝗈𝗋 𝗄𝖾 𝖮𝗐𝗇𝖾𝗋 𝖣𝖾𝗇𝗀𝖺𝗇 𝖢𝖺𝗋𝖺 /𝗅𝖺𝗉𝗈𝗋𝖻𝗎𝗀 ',
				levelnol: '*LEVEL LU NGAB KOK MASIH * 0 >_<',
				error: {
				...
				only: {
					...
					premium: 'Maaf tod Perintah Ini Hanya Untuk User Premium ',
					mod: 'Maaf tod Fitur Ini Untuk User Mods Veerbotz',
			...
			const ownerNumber = ["6281394931875@s.whatsapp.net","628pasangnomoryou@s.whatsapp.net"]
			const mod = [ownerNumber,"6281394931875@s.whatsapp.net","628pasangnomoryou@s.whatsapp.net"]
			...
			const premium = ["6281394931875@s.whatsapp.net","6282349516238@s.whatsapp.net","6282210159450@s.whatsapp.net","6289512703226@s.whatsapp.net","6283191156893@s.whatsapp.net","6287844366550@s.whatsapp.net"]
